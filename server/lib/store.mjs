...
export class DataStore {
  ...
  async ensureIndexes() {
    ...
    const indexes = {
      ...
      notification_workflows: [{ key: { event_key: 1, status: 1 }, name: 'notification_workflows_event_status' }],
      marketing_campaigns: [{ key: { status: 1, created_at: -1 }, name: 'marketing_campaigns_status_recent' }],
      intelligence_models: [{ key: { domain: 1, status: 1 }, name: 'intelligence_models_domain_status' }],
